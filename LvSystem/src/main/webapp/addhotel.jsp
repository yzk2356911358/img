		...
		<div class="layui-row">
			<div class="layui-card positionbox">
				<fieldset class="layui-elem-field layui-field-title"
					...
					<legend>新增酒店信息</legend>
				</fieldset>
				<form class="layui-form" action="./hoteladd" method="post" enctype="multipart/form-data">
					<div class="layui-form-item">
						<label class="layui-form-label"><span class="col-red">*</span>酒店名</label>
					...
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button type="submit" class="layui-btn layui-btn-normal">新增酒店信息</button>
						</div>
					</div>
				</form>
			</div>
